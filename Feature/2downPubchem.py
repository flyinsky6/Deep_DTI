##https://www.pythonheidong.com/blog/article/880690/0364d117f6b7f16eff9e
###利用pubchempy获取化合物的SMILES等信息
import urllib
import pubchempy
import pandas as pd
import numpy as np
    ...
    for k in  name_list:
        ...
        for l in results:
            try:
                ...
                print('CID: {}\tMass: {}\tName: {}\tMolfor: {}\tSmi: {}\tSyn: {}'.format(l.cid,l.exact_mass,l.iupac_name,l.molecular_formula,l.canonical_smiles,l.synonyms))
                MFs=l.molecular_formula
                MWs=l.molecular_weight
                ISs=l.canonical_smiles
                Sys=l.synonyms
                Cis=l.cid
                a.append(k)
                cc.append(MFs)
            ...
            dataframe.to_csv ("./imput_nr.csv",index=False,sep=',')
